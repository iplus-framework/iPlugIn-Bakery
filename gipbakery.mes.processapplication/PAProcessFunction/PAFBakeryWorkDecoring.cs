...
namespace gipbakery.mes.processapplication
{
    ...
    public class PAFBakeryWorkDecoring : PAFWorkTaskGeneric
    {
        ...
        public PAFBakeryWorkDecoring(gip.core.datamodel.ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier = "")
        ...
        {
            return c is PWBakeryWorkDecoring;
        }
        ...
        public static bool HandleExecuteACMethod_PAFBakeryWorkDecoring(out object result, IACComponent acComponent, string acMethodName, gip.core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
