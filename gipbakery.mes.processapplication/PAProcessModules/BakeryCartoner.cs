...
namespace gipbakery.mes.processapplication
{
    ...
    public class BakeryCartoner : PAProcessModuleVB
    {
        #region c'tors
        static BakeryCartoner()
        {
            RegisterExecuteHandler(typeof(BakeryCartoner), HandleExecuteACMethod_BakeryCartoner);
        }

        public BakeryCartoner(gip.core.datamodel.ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier = "")
