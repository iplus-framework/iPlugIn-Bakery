...
namespace gipbakery.mes.processapplication
{
    ...
    public class PWBakeryWorkCartoning : PWBakeryWorkTask
    {
        ...
        {
            Type thisType = typeof(PWBakeryWorkCartoning);
            ...
            RegisterExecuteHandler(thisType, HandleExecuteACMethod_PWBakeryWorkCartoning);
        }
